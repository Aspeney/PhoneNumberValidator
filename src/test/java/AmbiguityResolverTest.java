...
public class AmbiguityResolverTest {
    ...
    @Test
    void shouldTestSingleTokenInterpretationWithoutAmbiguity() {
        String[] tokens = {"10"};
    ...
    @Test
    void shouldTestSingleTokenInterpretationWithAmbiguity() {
        String[] tokens = {"21"};
        List<String> interpretations = resolver.generateInterpretations(tokens);
    ...
    @Test
    void shouldTestTwoTokensWithRegularAmbiguity() {
        String[] tokens = {"20", "1"};
        List<String> interpretations = resolver.generateInterpretations(tokens);
    ...
    @Test
    void shouldTestTwoTokensWithoutAmbiguity() {
        String[] tokens = {"11", "12"};
        List<String> interpretations = resolver.generateInterpretations(tokens);
    ...
    @Test
    void shouldStartOnlyAmbiguityIfAppliesOnlyAtStart() {
        String[] tokens = {"69", "30"};
        List<String> interpretations = resolver.generateInterpretations(tokens);
    ...
    @Test
    void shouldStartOnlyAmbiguityIfNotAppliedInMiddle() {
    ...
    @Test
    void shouldTestMultipleAmbiguitiesCombined() {
